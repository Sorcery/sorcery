  ...
  def provider_url(provider)
    {
      ...
      battlenet: "https://eu.battle.net/oauth/authorize?client_id=#{::Sorcery::Controller::Config.battlenet.key}&scope=openid&redirect_uri=http%3A%2F%2Fblabla.com&response_type=code"
    }[provider]
  end
end
