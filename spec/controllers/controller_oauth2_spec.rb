...
describe SorceryController, active_record: true, type: :controller do
  ...
  context 'with OAuth features' do
    ...
    [:github, :google, :liveid, :vk, :salesforce, :paypal, :slack, :wechat, :microsoft, :qq].each do |provider|
  ...
  describe 'OAuth with User Activation features' do
    ...
    [:github, :google, :liveid, :vk, :salesforce, :paypal, :wechat, :microsoft, :qq].each do |provider|
